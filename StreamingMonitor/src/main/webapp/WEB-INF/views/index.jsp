    ...
    <div class="box box-danger">
     ...
     <div class="row">
    	<div class="col-md-4">
    	 <div class="box box-danger">
            <div class="box-header with-border">
              <h3 class="box-title">클라이언트 운영체제</h3>
              ...
              <div class="row">
                <div class="col-md-8">
                  <div class="chart-responsive">
                    <canvas id="pieChart" height="298"></canvas>
                  </div>
                  <!-- ./chart-responsive -->
                </div>
                <!-- /.col -->
    	...
    	<div class="box box-danger">
              ...
              <div class="table-responsive">
                <table class="table no-margin">
                  ...
                  <tr>
                    ...
                    <td>토렌트</td>
                    <td>드라마</td>
                    <td>2017-06-16 13:29 </td>
                    <td><span class="label label-danger">수집실패</span></td>
                    <td><a href="#"><i class="fa fa-search-plus" aria-hidden="true"></i></a></td>
                  </tr>
           ...
           <!--    <a href="javascript:void(0)" class="btn btn-sm btn-info btn-flat pull-left">Place New Order</a> -->
              <a href="javascript:void(0)" class="btn btn-sm btn-default btn-flat pull-right">모두 보기</a>
            </div>
            <!-- /.box-footer -->
          </div>
    	</div>
    	...
    	<div class="box box-danger">
            <div class="box-header with-border">
              ...
              <h3 class="box-title">페이지별 수집 진행 진척도 TOP 5</h3>
...
<script>
  $(function () {
    ...
    var bar_data = {
      data: [["NAVER", 100], ["FILENORI", 97], ["LUCKWORLD", 76], ["APPLEFILE", 55], ["KAKAO", 39]],
      color: "#3c8dbc"
    };
